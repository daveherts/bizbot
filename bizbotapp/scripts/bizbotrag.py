...
# Embedded parameters
INSTRUCTIONS = "You are a helpful customer service assistant. Provide clear, polite answers using company information where available."
MAX_TOKENS = 100
TEMPERATURE = 0.22
...
def load_bizbot():
    ...
    return "✅ BizBot model with RAG support loaded."
