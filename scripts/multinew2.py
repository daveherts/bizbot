...
# Set model directory statically
MODEL_DIR = "/home/dave/project/bizbot/bizbot/models"
os.makedirs(MODEL_DIR, exist_ok=True)

# Define available models with static paths
MODEL_OPTIONS = {
    "Phi-4-Mini-Instruct": "microsoft/Phi-4-mini-instruct",
    "Qwen2.5-0.5B-Instruct": "Qwen/Qwen2.5-0.5B-Instruct",
    "LLaMA-3.2-1B-Instruct": "meta-llama/Llama-3.2-1B-Instruct",
    "Customer-Support-Instruct-1B": "dheerajdasari/Customer-support-instruct-1B",
    "BizBot-Finetuned": "/home/dave/project/bizbot/bizbot/models/llamaft"  # Static path to your fine-tuned model
}
...
with gr.Blocks() as demo:
    ...
    max_tokens_slider = gr.Slider(
        label="Response Length (Max Tokens)", minimum=50, maximum=500, value=150
    )
    temperature_slider = gr.Slider(
        label="Creativity (Temperature)", minimum=0.1, maximum=1.5, value=0.7
    )
    ...
    submit_button.click(
        chat,
        inputs=[user_input, model_dropdown, instruction_box, max_tokens_slider, temperature_slider],
