...
RESULTS_CSV = "benchmark2/results/base_vs_ft_loadtest_50.csv"
...
def benchmark_model(model_key, tokenizer, model):
    ...
    load_results = run_load_test(model, tokenizer, PROMPT, concurrency=CONCURRENCY)
...
def main():
    ...
    results.append(benchmark_model("llama-1b-base", base_tokenizer, base_model))

    ft_tokenizer, ft_model = load_finetuned_model()
    results.append(benchmark_model("llama-1b-ft", ft_tokenizer, ft_model))
